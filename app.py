...
# 公开路由（无需登录）
PUBLIC_ROUTES = {'/login', '/static'}  # /api/captcha → news_bp, /api/verify & /api/check_user_login_password → auth_bp
...
# @app.route('/api/check_verify') -> migrated to blueprints/auth


# @app.route('/api/user/set_password') -> migrated to blueprints/auth


# @app.route('/api/check_user_login_password') -> migrated to blueprints/auth


# @app.route('/api/user/verify_password') -> migrated to blueprints/auth


# @app.route('/api/user/check_password_verified') -> migrated to blueprints/auth


# @app.route('/api/user/get_password_prompt') -> migrated to blueprints/auth


# @app.route('/api/user/set_password_prompt') -> migrated to blueprints/auth
...
def set_news_schedule():
    ...
    # 更新调度器 (extensions.py)
    update_news_scheduler(app, _news_cache, _alumni_cache)
...
if __name__ == '__main__':
    init_news_scheduler(app, _news_cache, _alumni_cache)
