...
| bf67ad0 | 留言API返回avatar字段 |
| 35fc860 | 修复add_message缺少datetime导入 |
| 6876cf4 | 小程序通讯录添加附近同学和语音喊话 |
| 1b7755e | 添加附近同学和语音喊话API |
| cfcde15 | 修复get_wx_activities缺少datetime导入 |
| 8023edc | 使用exec启动Flask让systemd正确管理 |
| 0d48c2f | 小程序"我的"模块与网页深度对齐 |
| c12ed5e | 小程序留言板功能与网页对齐 |
| 8f0076d | 小程序媒体功能与网页对齐 |

项目在持续迭代中，最近重点是完善微信小程序功能，与网页端保持数据和体验一致。
